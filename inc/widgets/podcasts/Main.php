    ...
    protected function register_controls()
    {
        ...
        $this->add_control(
            ...
            [
                ...
                'return_value' => 'yes',
                'default' => 'yes',
                'prefix_class' => 'coo-elementor-podcast-list-more-',
            ]
        );
        ...
        //Pagination type
        $this->add_control(
            'coo_elementor_podcast_list_pagination_type',
            [
                'label' => __('Pagination Type', 'cooalliance-ele'),
                'type' => Controls_Manager::SELECT,
                'options' => [
                    'pagination' => __('Pagination', 'cooalliance-ele'),
                    'infinite_scroll' => __('Infinite Scroll', 'cooalliance-ele'),
                ],
        ...
        $this->add_responsive_control(
            ...
            [
                ...
                'size_units' => ['px', '%', 'em'],
                'selectors' => [
                    '{{WRAPPER}} .coo-elementor-podcast-search' => 'margin: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
                ],
            ]
        );
